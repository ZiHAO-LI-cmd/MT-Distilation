...
class InferenceDataset(Dataset):
    def __init__(self, source_texts, tokenizer, max_length=512,prefix=">>bel<< "):
        self.source_texts = self.source_texts = [prefix + text for text in source_texts]
...
def create_inference_dataloader(source_texts, tokenizer, batch_size=32, max_length=512, prefix=">>bel<< "):
...
def main():
    ...
    parser.add_argument('--prefix', type=str, default=">>bel<< ", help='Prefix to add to each sentence')
